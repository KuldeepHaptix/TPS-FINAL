<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="~/EmployeeAssignHolidayProfile.aspx.cs" Inherits="EmployeeManagement.EmployeeAssignHolidayProfile" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        <h1>Assign Holiday Profile To Employee
                <small>
    ...
    <section class="content">
            ...
            <div class="box-header">
                <div class="row">
                    <div class="col-md-12">
                        <br />
                        <div class="col-md-2">
                            <asp:Label ID="lblId" class="control-label" runat="server" Text="Select Holiday Profile "></asp:Label>
                        </div>
                        <div class="col-md-3">
                            <%--<select class=" form-control select2   select2-selection--single" style="width: 110%;" runat="server" id="ddlgrouplist" >
                            </select>--%>
                            <asp:DropDownList ID="ddlholidaylist" CssClass=" form-control select2" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlholidaylist_SelectedIndexChanged">
                            </asp:DropDownList>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-5">
                            <%--<span style="font-size: large">Employee List For Assign Holiday</span>--%>
                            ...
                            <asp:Button ID="BtnSave" runat="server" class="btn btn-primary" Text="Save" Width="150px" OnClick="BtnSave_Click"
        ...
        <script type="text/javascript">
            function validate() {
                if (document.getElementById("<%=ddlholidaylist.ClientID%>").value == "0") {
