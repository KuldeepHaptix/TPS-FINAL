                            ...
                            <%--   <asp:TemplateField HeaderText="CancelCompaint">
                                ...
                                <asp:TemplateField HeaderText="Delete">
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# Eval("comp_id")+":"+Eval("comp_id")  %>' CommandName="Delete" Text="Delete" OnClientClick="return confirm('Are you sure you want to Cancel  this Complaint?');"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
